...
class ReadSiniestro
{
    ...
    public function getSiniestroInformacion(
        ...
        #tabla SINIESTRO
        $mysqlQuery .= "sini.id_siniestro,sini.fecha_siniestro,sini.hora_siniestro, con.nombre_conductor, ";
        ...
        $mysqlQuery .= "INNER JOIN departamento depa ON depa.id_departamento = depa.id_departamento ";
        #Condicion
        $mysqlQuery .= "WHERE ";

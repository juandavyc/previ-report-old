...
class DatosConductor
{
    ...
    public function getDatosConductor($id_vehiculo)
    {
        // var_dump($id_vehiculo);

        $mysql_query = "SELECT ";
        $mysql_query .= "veh.id_vehiculo, con.id_conductor, CONCAT (con.nombre_conductor,'  ',con.apellido_conductor) AS nombre_completo,  CONCAT (tiid.nombre_tipo_identificacion,' - ', con.numero_documento) AS documento, ";
        ...
        $mysql_query .= "arl.nombre_arl, esarl.nombre_estado_arl ";

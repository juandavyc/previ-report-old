autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/clientes/conductor/assets/autocomplete/departamento_general/buscar_departamento.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/clientes/conductor/assets/autocomplete/departamento_general/crear_departamento.php',
...
autocomplete_with_insert_child({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/clientes/conductor/assets/autocomplete/ciudad_general/buscar_ciudad.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/clientes/conductor/assets/autocomplete/ciudad_general/crear_ciudad.php',
  input_value_default: 'INDEFINIDO',

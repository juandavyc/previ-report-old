...
<head>
    <title>Agregar Siniestro - Hojas de vida</title>
    <meta charset="utf-8" />
    ...
    <div id="page-wrapper">
        ...
        <article id="main">
            <header class="special container">
                ...
                <h2>Agregar Siniestro</h2>
                <p><?=htmlspecialchars($_SESSION["session_user"][3]);?></p>
            </header>

            <div id="tab-visor">
                <ul>
                    <li><a href="#tab-1" class="icon solid fa-plus"> Agregar </a></li>

                    <!-- <li><a href="#tab-1" class="icon solid fa-plus"> Agregar Siniestro </a></li> -->
                </ul>
                <div id="tab-1">
                    <?php require 'vista/agregar.html';?>
                    <?php require 'vista/info_conductor.html'?>
                </div>
                <!-- <div id="tab-2">
                </div> -->
            </div>

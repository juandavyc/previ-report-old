    ...
    if ($json_host['status'] == "ok") {
        ...
        if (
            ...
            if (strcmp($database->status(), "bien") == 0) {
                ...
                if ($id_accordion == 1) {
                    require DOCUMENT_ROOT . '/clientes/supervisor/assets/clases/vehiculo/read.php';
                    ...
                    require DOCUMENT_ROOT . '/clientes/supervisor/assets/clases/certificado_rtm/read.php';
                    ...
                    require DOCUMENT_ROOT . '/clientes/supervisor/assets/clases/poliza_soat/read.php';
                    ...
                    require DOCUMENT_ROOT . '/clientes/supervisor/assets/clases/datos_tecnicos_vehiculo/read.php';
                    ...
                    require DOCUMENT_ROOT . '/clientes/supervisor/assets/clases/revision_preventiva/read.php';
                    ...
                    require DOCUMENT_ROOT . '/clientes/supervisor/assets/clases/tarjeta_operacion/read.php';
                    ...
                    require DOCUMENT_ROOT . '/clientes/supervisor/assets/clases/poliza/read_c.php';

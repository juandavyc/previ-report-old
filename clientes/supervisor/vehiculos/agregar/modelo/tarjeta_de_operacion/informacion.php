    ...
    if ($json_host['status'] == "ok") {
        ...
        if (
            ...
            if (strcmp($database->status(), "bien") == 0) {
                ...
                $tarjetaOperacion = new ReadTarjetaOperacion($database->myconn);
                $arrayResponse = $tarjetaOperacion->getTarjetaOperacion(
                    array(
                        'TYPE' => 'ID',
                        'VALUE' => $id_elemento,
                    ),
                ...
                if ($arrayResponse['status'] == 'bien') {
                    ...
                    $json_message = $arrayResponse['tarjeta_operacion'];
                } else {
                    $json_status = $arrayResponse['status'];

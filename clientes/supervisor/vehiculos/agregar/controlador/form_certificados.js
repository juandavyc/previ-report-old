  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/vehiculos/agregar/modelo/certificados/form.php',
        type: 'POST',
        data: formdata,
        contentType: false,
        cache: false,
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/vehiculos/agregar/modelo/certificados/eliminar.php',
        type: 'POST',
        data: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/vehiculos/agregar/modelo/certificados/informacion.php',
        type: 'POST',
        data: {
          id_elemento: _id_elemento,
        },

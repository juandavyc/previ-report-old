  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/vehiculos/agregar/modelo/certificado_rtm/form_certificado_rtm.php',
        type: 'POST',
        data: formdata,
        contentType: false,
        cache: false,
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/vehiculos/agregar/modelo/certificado_rtm/eliminar_certificado.php',
        type: 'POST',
        data: {
          id_rtm: _id_rtm,
        },
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/vehiculos/agregar/modelo/certificado_rtm/buscar_informacion_rtm.php',
        type: 'POST',
        data: {
          id_rtm: _id_rtm,
        },

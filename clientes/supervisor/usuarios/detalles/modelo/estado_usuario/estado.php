...
if (
    isset($_POST["form_1_estado"]) &&
    isset($_POST["form_1_id_usuario"]) &&
    ...
    if ($json_host['status'] == "ok") {
        ...
        if (
            ...
            if (strcmp($database->status(), "bien") == 0) {
                ...
                $estado = ($_POST["form_1_estado"]);
                $id_usuario = encrypt($_POST["form_1_id_usuario"], 2);

                $usuario = new UpdateUsuario($database->myconn);
                $arrayResponse = $usuario->setEstado(
                    $estado,
                    $id_usuario
                );

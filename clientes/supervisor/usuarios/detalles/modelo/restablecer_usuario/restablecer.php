...
require DOCUMENT_ROOT . '/clientes/supervisor/assets/clases/usuario/update.php';

$headers = apache_request_headers();
// var_dump($_POST);

if (
    isset($_POST["form_2_razon"]) &&
    isset($_POST["form_2_id_usuario"]) &&
    ...
    if ($json_host['status'] == "ok") {
        ...
        if (
            ...
            if (strcmp($database->status(), "bien") == 0) {
                ...
                $razon = htmlspecialchars($_POST["form_2_razon"]);
                $id_usuario = encrypt($_POST["form_2_id_usuario"], 2);

                $usuario = new UpdateUsuario($database->myconn);
                $arrayResponse = $usuario->setRestablecer(
                    $razon,
                    $id_usuario
                );

...
<head>
    <title>Detalles Usuario - Hojas de vida</title>
    <meta charset="utf-8" />
    ...
    <div id="page-wrapper">
        ...
        <article id="main">
            ...
            <header class="special container">
                <span class="icon solid fa-user"><i class="fas fa-plus"></i></span>
            ...
            <section class="wrapper style4 container max">
                <div class="row gtr-50 gtr-uniform">
                    ...
                    <div class="col-12 align-center">
                        <h2 id="form_0_numero_usuario_div"></h2>
                        <h3 id="form_0_nombre_usuario_div"></h3>
                        <h4 id="form_0_cedula_usuario_div"></h4>
                    </div>


                    <div class="col-12">
                        <div id="vehiculo_agregar_accordion">
                            <h3 class="accordion_consulta" data-id="0"> Información del Usuario</h3>
                            <div id="accordion_consulta_0">
                                <?php require 'vista/form_informacion_usuario.html'; ?>
                            </div>
                            <h3 class="accordion_consulta" data-id="1"> Estado de la cuenta
                                <b>( Activo o Suspendido ) </b>
                            </h3>
                            <div id="accordion_consulta_1">
                                <?php require 'vista/form_estado.html'; ?>
                            </div>

                            <h3 class="accordion_consulta" data-id="2"> Restablecer contraseña </h3>
                            <div id="accordion_consulta_1">
                                <?php require 'vista/form_restablecer.html'; ?>
                            </div>

...
let self = $.confirm({
  ...
  content: function () {
    return $.ajax({
      url:
        PROTOCOL_HOST +
        '/clientes/supervisor/mantenimientos-taller/agregar/modelo/fotos_mantenimiento/guardar_foto.php',
      type: 'POST',
      data: formdata,
      contentType: false,
      cache: false,
...
let self = $.confirm({
  ...
  content: function () {
    return $.ajax({
      url:
        PROTOCOL_HOST +
        '/clientes/supervisor/mantenimientos-taller/agregar/modelo/fotos_mantenimiento/informacion_foto.php',
      type: 'POST',
      data: {

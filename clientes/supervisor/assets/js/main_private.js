...
function call_recuperar_session(_callback) {
  ...
  $.confirm({
    title: false,
    content:
      '<div class="row gtr-50 gtr-uniform" style="overflow-x: hidden;overflow-y: hidden;"><div class="col-12 align-center"><i class="fas fa-address-card fa-3x"></i><hr class="hr-text" data-content="Recuperación de sesión"></div><div class="col-12"> <label class="label-important"> Cedula</label> <div class="input-container"><i class="fa fa-user icon-input"></i><input type="text" name="usuario" id="usuario_inciar_sesion" maxlength="25" required="" autocomplete="off"></div> </div><div class="col-12"><label class="label-important"> Contraseña</label><div class="input-container"><i class="fa fa-lock icon-input"></i><input type="password" name="contrasenia" id="contrasenia_inciar_sesion" maxlength="25" required="" autocomplete="off"></div></div></div>',
    boxWidth: '365px',
    useBootstrap: false,
    buttons: {
      iniciar: {
      ...
      if (_task === 'ok') {
        let self = $.confirm({
          content: function () {
            return $.ajax({
              url:
                PROTOCOL_HOST + '/clientes/supervisor/assets/php/hdv_restaurar_session.php',
              type: 'POST',
              data: {
      ...
      function callback_next(callback) {
        ...
        $.confirm({
          ...
          content: function () {
            var self = this;
            return $.ajax({
              url: PROTOCOL_HOST + '/clientes/supervisor/assets/php/hoja_subir_archivo.php',
              dataType: 'json',
              type: 'POST',
              data: formData,
              contentType: false,

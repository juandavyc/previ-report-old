  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/conductores/agregar/modelo/fondo_pension/guardar_datos_fondo_pension_conductor.php',
        type: 'POST',
        data: formdata,
        contentType: false,
        cache: false,
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/conductores/agregar/modelo/fondo_pension/buscar_informacion_fondo_pension.php',
        type: 'POST',
        data: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/conductores/agregar/modelo/fondo_pension/eliminar_fondo_pension_conductor.php',
        type: 'POST',
        data: {
          id_fondo_pension_conductor: _id_fondo_pension_conductor,
        },

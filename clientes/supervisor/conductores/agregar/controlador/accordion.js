    ...
    $.confirm({
      ...
      content: function () {
        ...
        return $.ajax({
          url:
            PROTOCOL_HOST +
            '/clientes/supervisor/conductores/agregar/modelo/buscar_datos_conductor_general.php',
          type: 'POST',
          data: {
  ...
  $.confirm({
    ...
    buttons: {
      esta: {
        text: 'Esta pestaña',
        action: function () {
          window.location.href = PROTOCOL_HOST + '/clientes/supervisor/vehiculos/visor/';
        },
      },
      otra: {
        text: 'Otra pestaña',
        action: function () {
          window.open(PROTOCOL_HOST + '/clientes/supervisor/vehiculos/visor/');
        },
      },
    },
  });
  ...
  $.confirm({
    ...
    buttons: {
      esta: {
        text: 'Esta pestaña',
        action: function () {
          window.location.href = PROTOCOL_HOST + '/clientes/supervisor/empresas/visor/';
        },
      },
      otra: {
        text: 'Otra pestaña',
        action: function () {
          window.open(PROTOCOL_HOST + '/clientes/supervisor/empresas/visor/');
        },
      },
    },
  });

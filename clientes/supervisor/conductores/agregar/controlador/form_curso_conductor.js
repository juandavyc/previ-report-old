  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/conductores/agregar/modelo/curso_conductor/guardar.php',
        type: 'POST',
        data: formdata,
        contentType: false,
        cache: false,
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/conductores/agregar/modelo/curso_conductor/buscar.php',
        type: 'POST',
        data: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/conductores/agregar/modelo/curso_conductor/eliminar.php',
        type: 'POST',
        data: {
          id_curso_conductor: _id_curso_conductor,
        },

                ...
                <div class="row gtr-50 gtr-uniform ">
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_8_fecha_expedicion_examen_ocupacional_conductor" id="form_8_fecha_expedicion_examen_ocupacional_conductor" class="input_date_listener" autocomplete="off" value="01/01/2000" required="">
                        </div>
                    </div>
                    <div class="col-2 col-12-small">
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            <i class="fas fa-calendar icon-input"></i>
                            <input type="text" name="form_8_fecha_vencimiento_examen_ocupacional_conductor" id="form_8_fecha_vencimiento_examen_ocupacional_conductor" class="input_date_listener" autocomplete="off" value="01/01/2000" required="">
                        </div>
                    </div>

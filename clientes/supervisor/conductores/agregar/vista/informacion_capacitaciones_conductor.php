            ...
            <fieldset>
                ...
                <div class="row gtr-50 gtr-uniform ">
                    ...
                    <div class="col-2 col-12-small">
                        <label class="label-datos"> Nombre capacitacion</label>
                    </div>
                    <div class="col-4 col-12-small ">
                        <div class="input-container">
                            <i class="far fa-hospital icon-input"></i>
                            <input type="text" id="form_10_nombre_capacitacion" name="form_10_nombre_capacitacion" class="text-uppercase" required="" placeholder="Nombre Capacitación">
                        </div>
                    </div>
                    <div class="col-2 col-12-small">
                        <label class="label-datos"> Entidad capacitacion <b class="list-key"></b></label>
                    </div>
                    <div class="col-4 col-12-small ">
                        <div class="input-container">
                            <i class="far fa-hospital icon-input"></i>
                    ...
                    <div class="col-2 col-12-small">
                        <label class="label-datos"> Tipo capacitacion <b class="list-key"></b></label>
                    </div>
                    <div class="col-4 col-12-small ">
                        <div class="input-container">
                            <i class="far fa-hospital icon-input"></i>
                    ...
                    <div class="col-2 col-12-small">
                        <label class="label-datos "> Fecha Realización capacitacion </label>
                    </div>
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            <i class="fas fa-calendar icon-input"></i>
                            <input type="text" name="form_10_fecha_realizacion_capacitacion_conductor" id="form_10_fecha_realizacion_capacitacion_conductor" class="input_date_listener" autocomplete="off" value="01/01/2999" required="">
                        </div>
                    </div>
                    ...
                    <div id="div_datos_refuerzo" class="col-12" style="display: none">
                        <div class="col-2 col-12-small">
                            <label class="label-datos "> Fecha refuerzo Examen</label>
                        </div>
                        <div class="col-4 col-12-small">
                            <div class="input-container">
                                <i class="fas fa-calendar icon-input"></i>
                                <input type="text" name="form_10_fecha_refuerzo_capacitacion" id="form_10_fecha_refuerzo_capacitacion" class="input_date_listener" autocomplete="off" required="">
                            </div>
                        </div>
                    </div>

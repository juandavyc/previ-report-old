...
if (
    isset($_POST['form_7_tipo_comparendo_multa_sancion_conductor']) &&
    isset($_POST['form_7_fecha_comparendo_multa_sancion_conductor']) &&
    isset($_POST['form_7_motivo_comparendo_multa_sancion_conductor']) &&
    isset($_POST['form_7_foto_comparendo_multa_sancion']) &&
    ...
    if ($json_host['status'] == "ok") {
        ...
        if (
            ...
            if (strcmp($database->status(), "bien") == 0) {
                ...
                $form_7_tipo_comparendo = htmlspecialchars(strtoupper($_POST["form_7_tipo_comparendo_multa_sancion_conductor"]));
                $form_7_fecha_comparendo = getspecialdate(strtoupper($_POST["form_7_fecha_comparendo_multa_sancion_conductor"]));
                $form_7_motivo_comparendo = htmlspecialchars(strtoupper($_POST["form_7_motivo_comparendo_multa_sancion_conductor"]));
                $form_7_foto_comparendo = htmlspecialchars(($_POST["form_7_foto_comparendo_multa_sancion"]));
                $form_7_id_conductor = htmlspecialchars(strtoupper(encrypt($_POST["id_conductor"],2)));
                $form_id_usuario = $_SESSION['session_user'][1];
                
                $mysql_query = "call proc_conductor_comparendo_multa_sancion (?,?,?,?,?,?,@respuesta); ";

                $mysql_stmt = mysqli_prepare($database->myconn, $mysql_query);
                $mysql_stmt->bind_param(
                    'isssii',
                    $form_7_tipo_comparendo,
                    $form_7_fecha_comparendo,
                    $form_7_motivo_comparendo,
                    $form_7_foto_comparendo,
                    $form_7_id_conductor,
                    $form_id_usuario

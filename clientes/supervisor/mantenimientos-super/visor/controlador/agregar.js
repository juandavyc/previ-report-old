    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url:
            PROTOCOL_HOST +
            '/clientes/supervisor/mantenimientos-super/visor/modelo/crear_mantenimiento.php',
          type: 'POST',
          data: form_data,
          headers: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/supervisor/mantenimientos-super/visor/modelo/informacion_vehiculo.php',
        type: 'POST',
        data: {

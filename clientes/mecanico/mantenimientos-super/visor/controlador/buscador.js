...
export function fun_buscador_functions(_function_info, _function_link,_function_pdf) {
...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/clientes/mecanico/assets/autocomplete/empresa_general/buscar_empresa.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/clientes/mecanico/usuarios/visor/modelo/crear_empresa.php',
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/mecanico/mantenimientos-super/visor/modelo/buscador.php',
        type: 'POST',
        data: form_data,
        headers: {

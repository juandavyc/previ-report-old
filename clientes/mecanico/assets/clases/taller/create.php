...
class CreateTaller
{
    ...
    public function setTallerNit($_nit = 1, $_id_usuario = 1, $_empresa = 1)
    {

        $mysqlQuery = "CALL proc_crear_nit_taller (?,?,?,@respuesta); ";

        $mysqlStmt = mysqli_prepare($this->databaseConnection, $mysqlQuery);
        $mysqlStmt->bind_param('sii', $_nit, $_id_usuario, $_empresa);

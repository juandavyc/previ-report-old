    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url:
            PROTOCOL_HOST +
            '/clientes/mecanico/mantenimientos-taller/agregar/modelo/procedimiento_mantenimiento/guardar.php',
          type: 'POST',
          data: formdata,
          contentType: false,
          cache: false,
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/mecanico/conductores/agregar/modelo/vehiculo_conductor/buscar.php',
        type: 'POST',
        data: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/mecanico/conductores/agregar/modelo/vehiculo_conductor/eliminar.php',
        type: 'POST',
        data: {
          id_vehiculo_conductor: _id_vehiculo_conductor,
        },

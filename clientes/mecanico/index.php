...
<body data-id="inicio">
    <div id="page-wrapper">
        ...
        <article id="main">
                    <?php require DOCUMENT_ROOT . '/clientes/mecanico/habeas/habeas_data.html';?>
            ...
            <section class="wrapper style4 container small">
                <div class="row gtr-50 gtr-uniform">
                    ...
                    <div class="col-8 col-12-small">
                         <a href="/clientes/mecanico/mantenimientos-super/visor/" class="button primary small fit"> GESTIONAR MANTENIMIENTO</a>
                    </div>
                    <div class="col-2 col-12-small"></div>

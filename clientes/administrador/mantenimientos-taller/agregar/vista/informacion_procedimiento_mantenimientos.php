                ...
                <div class="row gtr-50 gtr-uniform ">
                    ...
                    <div class="col-9  col-12-small">
                        <div class="input-container">
                            ...
                            <input class="text-uppercase" type="text" placeholder="repuestos a utilizar y/o consumibles"
                                name="form_2_repuesto_mantenimiento" id="form_2_repuesto_mantenimiento"
                    ...
                    <div class="col-3 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_2_fecha_inicial_mantenimiento"
                                id="form_2_fecha_inicial_mantenimiento" class="input_date_listener" autocomplete="off"
                                value="01/01/2021" required="" />
                        </div>
                    </div>
                    ...
                    <div class="col-3 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="time" name="form_2_hora_inicio_mantenimiento"
                                id="form_2_hora_inicio_mantenimiento">
              ...
              <div class="input-container">
                ...
                <select id="form_2_tipo_mantenimiento" name="form_2_tipo_mantenimiento" required="">
                  ...
                  <option value="5">POST REPARACION</option>
                    ...
                    <div class="col-9 col-12-small">
                        <div class="input-container">
                            <textarea id="form_2_descripcion_trabajo_a_realizar"
                                name="form_2_descripcion_trabajo_a_realizar" rows="2" required=""
                                placeholder="DESCRIPCION DEL PROCEDIMIENTO A REALIZAR"></textarea>
                        </div>
                    </div>
        ...
        <div class="col-12">
            <fieldset>
                ...
                <div class="row gtr-50 gtr-uniform ">
                    ...
                    <div class="col-9 col-12-small">
                        <div class="input-container">
                            <textarea id="form_2_descripcion_procedimiento_realizado"
                                name="form_2_descripcion_procedimiento_realizado" rows="2" required=""
                                placeholder="DESCRIPCION DEL PROCEDIMIENTO REALIZADO"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-3 col-12-small">
                        <div class="input-container">
                            <i class="fas fa-calendar icon-input"></i>
                            <input type="text" name="form_2_fecha_final_mantenimiento"
                                id="form_2_fecha_final_mantenimiento" class="input_date_listener" autocomplete="off"
                                value="01/01/2021" required="" />
                        </div>
                    </div>
                    ...
                    <div class="col-3 col-12-small">
                        <div class="input-container">
                            ...
                            <i class="fas fa-clock icon-input"></i>
                            <input type="time" name="form_2_hora_final_mantenimiento"
                                id="form_2_hora_final_mantenimiento">

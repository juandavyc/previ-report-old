...
function fun_form_7() {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST + '/clientes/administrador/vehiculos/agregar/modelo/polizas/form.php',
        type: 'POST',
        data: formdata,
        contentType: false,
        cache: false,
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/administrador/vehiculos/agregar/modelo/polizas/eliminar.php',
        type: 'POST',
        data: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/administrador/vehiculos/agregar/modelo/polizas/informacion.php',
        type: 'POST',
        data: {
          id_poliza: _id_poliza,
        },

...
<head>
    <title>Visor de vehículos - Hojas de vida</title>
    <meta charset="utf-8" />
        ...
        <article id="main">
            ...
            <div id="tab-visor">
                <ul>
                    ...
                    <li><a href="#tab-2" class="icon solid fa-plus"> Agregar vehículo </a></li>
                </ul>
                <div id="tab-1">
                    <?php require 'vista/buscador_de_vehiculos.php';?>
                </div>
                <div id="tab-2">
                    <?php require 'vista/agregar_por_placa.php';?>
                </div>
            </div>

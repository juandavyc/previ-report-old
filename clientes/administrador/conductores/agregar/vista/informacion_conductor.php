<form id="form_1_informacion_basica" name="form_1_informacion_basica">
    ...
    <div class="row gtr-50 gtr-uniform">
        ...
        <div class="col-6 col-12-mobilep align-center">
            <span class="image fit">
                <a href="/images/sin_imagen.png" class="licencia-images-link" id="form_1_href_foto_conductor"
                    target="_blank">
                    <img src="/images/sin_imagen.png">
                </a>
            </span>
                ...
                <div class="row gtr-50 gtr-uniform">
                    ...
                    <div class="col-12">
                        <div class="photo-control">
                            <div class="photo-info">
                                <label>Foto conductor</label>
                                <input type="text" id="form_1_foto_conductor" name="form_1_foto_conductor"
                                    value="/images/sin_imagen.png" readonly required />
                            </div>
                            <div class="photo-buttons">
                                <button class="button primary small btn-camera-open" id="btn-form_1_foto_conductor"
                                    data-folder="conductores" input-id="form_1_foto_conductor"></button>
                                <button class="button primary small btn-camera-show"
                                    data-id="form_1_foto_conductor"></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input class="text-uppercase" type="text" placeholder="NOMBRES"
                                name="form_1_nombre_conductor" id="form_1_nombre_conductor" autocomplete="off"
                                required="">
                        </div>
                    </div>
                    <div class="col-2 col-12-small">
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            <i class="fas fa-signature icon-input"></i>
                            <input class="text-uppercase" type="text" placeholder="APELLIDOS"
                                name="form_1_apellido_conductor" id="form_1_apellido_conductor" autocomplete="off"
                                required="">
                        </div>
                    </div>
                    <div class="col-2 col-12-small">
                        <label class="label-datos ">Documento de identidad </label>
                    </div>
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_1_direccion_conductor" id="form_1_direccion_conductor"
                                autocomplete="off" required="" class="text-uppercase" placeholder="Cra 31 nro 17 -200">
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_1_telefono_conductor" id="form_1_telefono_conductor"
                                autocomplete="off" required="" class="text-uppercase" placeholder="90178481">
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_1_celular_conductor" id="form_1_celular_conductor"
                                autocomplete="off" required="" class="text-uppercase" placeholder="313 131 13 13">
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_1_whatsapp_conductor" id="form_1_whatsapp_conductor"
                                autocomplete="off" required="" class="text-uppercase" placeholder="310 000 00 00">
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_1_correo_electronico_conductor"
                                id="form_1_correo_electronico_conductor" autocomplete="off" required=""
                                class="text-uppercase" placeholder="CORREO@CORREO.COM">
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-12-small ">
                        <div class="input-container">
                            ...
                            <input type="text" id="form_1_departamento_conductor_input" value="SIN_DEPARTAMENTO"
                                placeholder="Nombre de la clase" class="text-uppercase" required="">
                            <input type="hidden" name="form_1_departamento_conductor"
                                id="form_1_departamento_conductor_select" value="0" required="">
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-12-small ">
                        <div class="input-container">
                            ...
                            <input type="text" id="form_1_ciudad_conductor_input" value="SIN_CIUDAD"
                                class="text-uppercase" required="">
                            <input type="hidden" name="form_1_ciudad_conductor" id="form_1_ciudad_conductor_select"
                                value="0" required="">
                        </div>
                    </div>
                    <!-- <div class="col-2 col-12-small">
                    ...
                    <div class="col-10 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" a="" id="form_1_empresa_input" value="SIN EMPRESA" placeholder="Empresa"
                                class="text-uppercase autocomplete ui-autocomplete-input" required="">

            ...
            <div class="row gtr-50 gtr-uniform ">
                ...
                <div class="col-4 col-12-small ">
                    <div class="input-container">
                        ...
                        <input type="text" id="form_3_eps_conductor_input" class="text-uppercase" required="" placeholder="NOMBRE EPS">
                        <input type="hidden" name="form_3_eps_conductor" id="form_3_eps_conductor_select" value="1" required="">
                    </div>
                </div>
                <div class="col-2 col-12-small">
                ...
                <div class="col-4 col-12-small">
                    <div class="input-container">
                        ...
                        <input type="text" name="form_3_eps_fecha_afiliacion_conductor" id="form_3_eps_fecha_afiliacion_conductor" class="input_date_listener" autocomplete="off" value="01/01/2000" required="">
                    </div>
                </div>
                ...
                <div class="col-4 col-12-small">
                    <div class="input-container">
                        ...
                        <select id="form_3_eps_estado_conductor" name="form_3_eps_estado_conductor" required="" value = 2 >
                ...
                <div class="col-12 col-12-small">
                    <div class="photo-control">
                        <div class="photo-info">
                            ...
                            <input type="text" id="form_3_foto_eps" name="form_3_foto_eps" value="/images/sin_imagen.png" readonly required />
                        </div>
                        <div class="photo-buttons">
                            <button class="button primary small btn-camera-open" id="btn-form_3_foto_eps" data-folder="eps" input-id="form_3_foto_eps"></button>

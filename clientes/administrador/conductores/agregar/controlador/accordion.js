...
export function fun_accordion_consulta_conductor(_temp_data_id, _check) {
  ...
  if (
    ...
    // console.log($id_conductor+"-->"+_temp_data_id);
    $.confirm({
      title: 'Error ',
      ...
      content: function () {
        ...
        return $.ajax({
          url:
            PROTOCOL_HOST +
            '/clientes/administrador/conductores/agregar/modelo/buscar_datos_conductor_general.php',
          type: 'POST',
          data: {
  ...
  $.confirm({
    ...
    buttons: {
      esta: {
        text: 'Esta pestaña',
        action: function () {
          window.location.href = PROTOCOL_HOST + '/clientes/administrador/vehiculos/visor/';
        },
      },
      otra: {
        text: 'Otra pestaña',
        action: function () {
          window.open(PROTOCOL_HOST + '/clientes/administrador/vehiculos/visor/');
        },
      },
    },
  });
  ...
  $.confirm({
    ...
    buttons: {
      esta: {
        text: 'Esta pestaña',
        action: function () {
          window.location.href = PROTOCOL_HOST + '/clientes/administrador/empresas/visor/';
        },
      },
      otra: {
        text: 'Otra pestaña',
        action: function () {
          window.open(PROTOCOL_HOST + '/clientes/administrador/empresas/visor/');
        },
      },
    },
  });

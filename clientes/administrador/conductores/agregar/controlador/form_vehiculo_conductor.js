...
let accordion_vehiculo = null;
export function fun_vehiculo_conductor_accordion(_funtion_name, _function_vehiculo) {
  accordion_busqueda = _funtion_name;
  accordion_vehiculo = _function_vehiculo;
}
$('.btn-crear-vehiculo').on('click', function (e) {
...
$('#form_12_vehiculo_conductor').on('submit', function (e) {
...
function fun_form_vehiculo_conductor_accordion() {

  let status_accordion = false;

  let formdata = new FormData($('#form_12_vehiculo_conductor')[0]);
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/administrador/conductores/agregar/modelo/vehiculo_conductor/guardar.php',
        type: 'POST',
        data: formdata,
        contentType: false,
        cache: false,
        ...
        .done(function (response) {
          if (response.status === 'bien') {
            ...
            $('#form_12_vehiculo_conductor').trigger("reset");
          } else if (
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/administrador/conductores/agregar/modelo/vehiculo_conductor/buscar.php',
        type: 'POST',
        data: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/administrador/conductores/agregar/modelo/vehiculo_conductor/eliminar.php',
        type: 'POST',
        data: {
          id_vehiculo_conductor: _id_vehiculo_conductor,
        },

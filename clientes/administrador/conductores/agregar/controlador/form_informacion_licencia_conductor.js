  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/administrador/conductores/agregar/modelo/licencia/guardar.php',
        type: 'POST',
        data: formdata,
        contentType: false,
        cache: false,
        ...
        .done(function (response) {
          if (response.status === 'bien') {
            ...
            call_recuperar_session(function (k) {
              fun_form_licencia_conductor_accordion();
            });
          } else {
            self.setTitle(response.status);
            self.setContent(response.message);
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/administrador/conductores/agregar/modelo/licencia/buscar.php',
        type: 'POST',
        data: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/administrador/conductores/agregar/modelo/licencia/eliminar.php',
        type: 'POST',
        data: {
          id_licencia_conductor: _id_licencia_conductor,
        },

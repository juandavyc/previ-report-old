        ...
        if (
            ...
            if (strcmp($database->status(), "bien") == 0) {
                ...
                if (strcmp($id_consulta, "1") == 0) {
                    ...
                    require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/datos_conductor/read_id_conductor.php';
                    ...
                    require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/contacto_emergencia/read.php';
                    ...
                    require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/eps/read.php';
                    ...
                    require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/arl/read.php';

...
require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/preoperacional/mecanico/create.php';
// var_dump($_POST);
...
// JSON CON TODO EL PREOPERATIVO
                ...
                $json_preoperativo, $id_usuario, $id_preoperativo, 
                $resultado_preoperativo, $observaciones_conductor, $firma_supervisor,
                $foto_1, $foto_2);

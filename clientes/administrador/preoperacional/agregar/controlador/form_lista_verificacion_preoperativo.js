    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url:
            PROTOCOL_HOST +
            '/clientes/administrador/preoperacional/agregar/modelo/listado_preoperativo/guardar_listado_preoperativo.php',
          type: 'POST',
          data: formdata,
          contentType: false,
          cache: false,
        ...
        if(fun_form_1_status == true){
          window.location.href =
            PROTOCOL_HOST +
            '/clientes/administrador/preoperacional-super/visor/';
        }
      },
      buttons: {
        aceptar: function () { },

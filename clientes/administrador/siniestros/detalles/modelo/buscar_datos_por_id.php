...
require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/siniestro/read.php';
require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/agente/read.php';
require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/testigo/read.php';
require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/vehiculo_implicado/read.php';

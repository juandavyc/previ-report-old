...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST + '/clientes/administrador/assets/autocomplete/conductor_general/buscar.php',
  url_insert_ajax: '/clientes/administrador/assets/autocomplete/conductor_general/guardar.php',
  input_value_default: 'TODO',
  input_select_default: '0',
  input_childs: [],
  is_todo: true,
...
function fun_form_0_buscador(_type) {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url: PROTOCOL_HOST + '/clientes/administrador/siniestros/visor/modelo/buscador.php',
        type: 'POST',
        data: form_data,
        headers: {

  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/administrador/siniestros/visor/modelo/buscador_informacion.php',
        type: 'POST',
        data: {
...
function fun_asignar_datos(_response) {
  ...
  <i class="fas fas fa-car fa-3x"></i></div><div class="col-12"><hr class="hr-text" data-content="Información">
    ...
    _response.implicados_siniestro > 1 ? 'Sin Implicados' : `Con Implicados`
  }</label> 
  </div><div class="col-12"><hr class="hr-text" data-content="Fotografías Siniestro"></div>
  <div class="col-3 col-6-xsmall align-center"><span class="image fit"><img src="${
    _response.foto_1

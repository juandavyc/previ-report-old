...
require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/certificado_empresa/update.php';
    ...
    if ($json_host['status'] == "ok") {
        ...
        if (
            ...
            if (strcmp($database->status(), "bien") == 0) {
                ...
                $certificado = new UpdateCertificado($database->myconn);
                $arrayResponse = $certificado->setIsVisible(
                    array(
                        'TYPE' => 'ID',
                        'VALUE' => $id_elemento,

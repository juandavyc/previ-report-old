...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST + '/clientes/administrador/assets/autocomplete/taller_general/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/clientes/administrador/assets/autocomplete/taller_general/crear.php',
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url:
            PROTOCOL_HOST +
            '/clientes/administrador/usuarios/detalles/modelo/informacion_usuario/form_informacion.php',
          type: 'POST',
          data: formdata,
          contentType: false,
          cache: false,

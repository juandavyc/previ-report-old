...
require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/usuario/read.php';
        ...
        if (
            ...
            if (strcmp($database->status(), "bien") == 0) {
                ...
                $php_array_filtro = array(
                    '0' => "usua.id_usuario",
                    '1' => "usua.id_usuario",
                    '2' => "usua.cedula_usuario",
                    '3' => "usua.nombre_usuario",
                    '4' => "usua.apellido_usuario",
                    '5' => "usua.correo_usuario",
                    '6' => "usua.telefono_usuario",
                );
                $php_array_order = array(
                    'nro' => "usua.id_usuario",
                    'cedula' => "usua.cedula_usuario",
                    'nombre' => "usua.nombre_usuario",
                    'apellido' => "usua.apellido_usuario",
                    'empresa' => "empr.nombre_empresa",
                    'rango' => "rang.nombre_rango",
                    'estado' => "estd.nombre_estado",
                    'opciones' => "usua.id_usuario",
                );
                $php_array_by = array(
                    'asc' => "ASC",
                    'desc' => "DESC",
                ...
                $form_rango = htmlspecialchars($_POST["form_0_rango"]);
                $form_empresa = $_SESSION['session_user'][2];
                $form_estado = htmlspecialchars($_POST["form_0_estado"]);
                ...
                $arrayResponse = $usuario->getUsuarioBuscador(
                    array(

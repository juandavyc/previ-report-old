            ...
            <section class="wrapper style4 container medium" style="padding: 2em;">
                <div class="row gtr-50 gtr-uniform">
                    <div class="col-4 col-12-small">
                        ...
                        <ol class="ol-mapa">
                            <li> <a href="<?=ROOT?>/clientes/administrador/">Inicio</a> </li>
                            <li> <a href="<?=ROOT?>/clientes/administrador/documentacion.php">Documentacion </a></li>
                            <li> Modulos</li>
                            <ol class="ol-mapa">
                                ...
                                <li>
                                    <a href="<?=ROOT?>/clientes/administrador/mantenimientos-super/visor/">Mantenimientos
                                    </a>
                                </li>
                                <li><a href="<?=ROOT?>/clientes/administrador/preoperacional-super/visor/">Preoperacional
                                    </a></li>
                            </ol>
                            <li> Mi cuenta</li>
                            <ol class="ol-mapa">
                                ...
                                <li>
                                    <a id="cerrar_sesion_act" name="cerrar_sesion_act"
                                        href="<?=ROOT?>/clientes/administrador/cerrar.php">Cerrar
                                        sesion</a>
                                </li>
                            </ol>
                        </ol>
                                ...
                                <div class="input-container">
                                    ...
                                    <select id="tipo-video-select" required="">
                                        ...
                                        <optgroup label="Modulos">
                                            ...
                                            <option value="6">Siniestros</option>

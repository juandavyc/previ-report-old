...
require DOCUMENT_ROOT . '/clientes/administrador/assets/clases/taller/create.php';
    ...
    if ($json_host['status'] == "ok") {
        ...
        if (
            ...
            if (strcmp($database->status(), "bien") == 0) {
                ...
                $taller = new CreateTaller($database->myconn);
                $arrayResponse = $taller->setTallerNit($nit, $id_usuario, $empresa);

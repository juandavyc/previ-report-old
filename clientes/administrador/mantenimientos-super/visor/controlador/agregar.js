    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url:
            PROTOCOL_HOST +
            '/clientes/administrador/mantenimientos-super/visor/modelo/crear_mantenimiento.php',
          type: 'POST',
          data: form_data,
          headers: {
          ...
          .done(function (response) {
            ...
            if (response.status === 'bien') {
              ...
              window.location.replace(
                PROTOCOL_HOST +
                  '/clientes/administrador/mantenimientos-taller/agregar/index.php?id=' +
                  response.message
              );
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/clientes/administrador/mantenimientos-super/visor/modelo/informacion_vehiculo.php',
        type: 'POST',
        data: {

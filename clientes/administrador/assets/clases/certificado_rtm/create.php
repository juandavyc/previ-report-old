...
class CreateCertificadoRTM
{
    ...
    public function setCertificadoRTM(
        $_id_cda = 1,
        $_numero_rtm = '',
        $_fecha_expedicion_rtm = '2999-01-01',
        $_fecha_vencimiento_rtm = '2999-01-01',
        $_foto_certificado_rtm = '/images/sin_imagen.png',
        $_id_vehiculo = 1,
        $_id_usuario = 1
    ) {
        $mysqlQuery = "CALL proc_vehiculo_certificado_rtm ";
        ...
        $mysqlStmt->bind_param(
            ...
            $_id_cda,
            $_numero_rtm,
            $_fecha_expedicion_rtm,
            $_fecha_vencimiento_rtm,
            $_foto_certificado_rtm,
            $_id_vehiculo,
            $_id_usuario,
        );

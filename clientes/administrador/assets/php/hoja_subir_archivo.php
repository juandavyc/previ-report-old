...
if (isset($_FILES['file']) &&
    ...
    $name = htmlspecialchars(time() . '_' . clean_file_name($name));
    $size = $_FILES['file']['size'];
    $src = "/clientes/administrador/assets/uploads/" . $folder . "/" . $name;

    move_uploaded_file($_FILES['file']['tmp_name'], '../uploads/' . $folder . '/' . $name);

...
/* invocar js */
/*fun_camera_photo('https://192.168.1.50/clientes/administrador/test_drag_and_drop/', 30, 0);*/
  ...
  function camera_canvas_upload() {
    ...
    if (camera_streaming == true) {
      ...
      let self = $.confirm({
        ...
        content: function () {
          return $.ajax({
            url: PROTOCOL_HOST + '/clientes/administrador/assets/php/my_camera_upload.php',
            type: 'POST',
            data: {

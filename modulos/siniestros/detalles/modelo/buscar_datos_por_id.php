...
require DOCUMENT_ROOT . '/modulos/assets/clases/siniestro/read.php';
require DOCUMENT_ROOT . '/modulos/assets/clases/agente/read.php';
require DOCUMENT_ROOT . '/modulos/assets/clases/testigo/read.php';

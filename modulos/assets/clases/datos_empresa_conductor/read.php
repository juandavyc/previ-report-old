...
class DatosEmpresaConductor
{
    ...
    public function getDatosEmpresaConductor($id_conductor)
        {

       
        $mysql_query = "SELECT ";
        $mysql_query .= "con.id_conductor,veh.id_vehiculo,emp.nombre_empresa, emp.nit, emp.correo, emp.telefono, emp.direccion, ciu.nombre_ciudad, dep.nombre_departamento, conco.tiempo_en_empresa_conductor, ";
        ...
        $mysql_query .= " LEFT JOIN vehiculo veh ON vehco.id_vehiculo = veh.id_vehiculo  ";
         ...
         #Condicion
            $mysql_query .= "WHERE con.id_conductor = ? ";

...
class FotosVehiculo
{
    ...
    public function getFotosVehiculo($id_vehiculo)
    {
        ...
        $mysql_query = "SELECT ";
        $mysql_query .= "veh.id_vehiculo, veh.foto_costado_derecho, veh.foto_costado_izquierdo, veh.foto_delantera, veh.foto_trasera, veh.impronta_chasis, veh.impronta_motor, veh.impronta_opcional_1,veh.impronta_opcional_2,veh.impronta_opcional_3,veh.impronta_serial, veh.licencia_transito_delantera, veh.licencia_transito_trasera ";
        ...
        if ($mysql_stmt->execute()) {
            ...
            while ($row = $result->fetch_assoc()) {
                array_push($this->array_fotos_vehiculos, array(
                    ...
                    'impronta_opcional_1' => $row['impronta_opcional_1'],
                    'impronta_opcional_2' => $row['impronta_opcional_2'],
                    'impronta_opcional_3' => $row['impronta_opcional_3'],

...
class readConductor
{
    ...
    public function getConductor($_condicional_ = array(
        ...
        $mysql_query .= "arl.nombre_arl, esarl.nombre_estado_arl , con.apellido_conductor, empr.nombre_empresa,empr.id_empresa,empr.nit ";
        ...
        $mysql_query .= "LEFT JOIN empresa empr ON empr.id_empresa = con.id_empresa ";

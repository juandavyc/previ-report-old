...
class DatosVehiculo
{
    ...
    public function getDatosVehiculo($id_vehiculo)
    {
        ...
        $mysql_query .= "veh.capacidad_carga, veh.peso_bruto_vehicular, veh.capacidad_pasajeros, veh.capacidad_pasajeros_sentados, veh.numero_ejes, tao.numero_tarjeta_operacion, ";
        ...
        $mysql_query .= "raac.nombre_radio_accion, estao.nombre_estado_tarjeta_operacion, veh.fecha_formulario,  CONCAT (usu.nombre_usuario,'  ', usu.apellido_usuario) as nombre_completo, habve.firma_habeas, dat.nombre_habeas_data, habve.fecha_formulario_habeas_vehiculo ";
        ...
        $mysql_query .= "LEFT JOIN  revision_preventiva revpre ON veh.id_vehiculo = revpre.id_vehiculo ";
        ...
        $mysql_query .= "LEFT JOIN habeas_vehiculo habve ON veh.id_vehiculo = habve.id_vehiculo ";
        $mysql_query .= "LEFT JOIN habeas_data dat ON habve.id_habeas_data = dat.id_habeas_data ";
        ...
        if ($mysql_stmt->execute()) {
            ...
            while ($row = $result->fetch_assoc()) {
                array_push($this->array_datos_vehiculo, array(
                    ...
                    'peso_vehiculo' => $row['peso_bruto_vehicular'],
                    ...
                    'nombre_completo_habeas' => $row['nombre_completo'],
                    'habeas_data' => $row['nombre_habeas_data'],
                    'fecha_hora_habeas' => $row['fecha_formulario_habeas_vehiculo'],
                    # ternario
                    'firma_habeas' => (is_null($row['firma_habeas']) ? '/images/sin_firma.png' : $row['firma_habeas']),

...
class ReadSiniestro
{
    ...
    public function getSiniestroBuscador(
        ...
        $mysqlQueryColumns .= "empr.nombre_empresa,tsini.nombre_tipo_siniestro,con.nombre_conductor, con.apellido_conductor,veh.placa_vehiculo ";
        #Tabla
        $mysqlQuery = "FROM ";
        $mysqlQuery .= "siniestro sini ";
        $mysqlQuery .= "INNER JOIN vehiculo veh ON veh.id_vehiculo = sini.id_vehiculo ";
        ...
        $mysqlQuery .= "AND tsini.id_tipo_siniestro LIKE ? ";
        $mysqlQuery .= "AND sini.fecha_siniestro BETWEEN ? AND ? ";
                    ...
                    while ($row = $mysqlResult->fetch_assoc()) {
                        array_push(
                            ...
                            array(
                                ...
                                "conductor" => htmlspecialchars($row['nombre_conductor'].' '.$row['apellido_conductor']),

    ...
    if (
        ...
        if (strcmp($database->status(), "bien") == 0) {
            ...
            if (strcmp($id_accordion, "1") == 0) {
                ...
                $mysql_query .= "man.precio_repuestos_mantenimiento_total, man.precio_repuestos_mantenimiento_total, man.cantidad_repuestos_mantenimiento_total,empr.nombre_empresa ";
                ...
                $mysql_query .= "INNER JOIN empresa empr ON empr.id_empresa = veh.id_empresa ";

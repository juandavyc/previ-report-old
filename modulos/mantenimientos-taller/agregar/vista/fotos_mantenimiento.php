<fieldset>
    <legend>
        <i class="far fa-folder-open"></i> Historial Fotos del mantenimiento
    </legend>
                    ...
                    <div class="col-12">
                        <div class="photo-control">
                            ...
                            <div class="photo-buttons">
                                <button class="button primary small btn-file-open" id="btn-form_3_foto" data-folder="fotos_mantenimiento" input-id="form_3_foto"></button>

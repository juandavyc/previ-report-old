                ...
                <div class="row gtr-25 gtr-uniform ">
                    ...
                    <div class="col-10 col-12-small">
                        <div class="input-container">
                            ...
                            <input class="text-uppercase" type="text" placeholder="nombre del repuesto" name="form_4_nombre_repuesto" id="form_4_nombre_repuesto" autocomplete="off" required="">
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input class="text-uppercase" type="number" placeholder="cantidad del repuesto" name="form_4_cantidad_repuesto" id="form_4_cantidad_repuesto" autocomplete="off" required="">
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input class="text-uppercase" type="text" placeholder="valor del repeusto" name="form_4_valor_repuesto" id="form_4_valor_repuesto" autocomplete="off" required="">
                        </div>
                    </div>
                </div>
            </fieldset>
        ...
        <div class="col-12" hidden>
            <fieldset>
                ...
                <div class="row gtr-50 gtr-uniform ">
                    ...
                    <div class="col-12">
                        <textarea id="form_4_notas_repuesto_mantenimiento" name="form_4_notas_repuesto_mantenimiento" rows="2" required="">...</textarea>
                    </div>
                </div>
            </fieldset>
        </div>

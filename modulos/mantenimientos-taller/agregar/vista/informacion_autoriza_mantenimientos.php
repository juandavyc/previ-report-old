            ...
            <div class="col-12">
                <fieldset>
                    ...
                    <div class="row gtr-25 gtr-uniform">
                        ...
                        <div class="col-4 col-12-small">
                            <label class="label-datos "> Nombre de quien autoriza </label>
                        </div>
                        <div class="col-8 col-12-small">
                            <div class="input-container">
                        ...
                        <div class="col-4 col-12-small">
                            <label class="label-datos "> Documento de quien autoriza</label>
                        </div>
                        <div class="col-8 col-12-small">
                            <div class="input-container">
                        ...
                        <div class="col-4 col-12-small">
                            <label class="label-datos "> Telefono de quien autoriza</label>
                        </div>
                        <div class="col-8 col-12-small">
                            <div class="input-container">
                        ...
                        <div class="col-4 col-12-small">
                            <label class="label-datos "> Cargo de quien autoriza </label>
                        </div>
                        <div class="col-8 col-12-small">
                            <div class="input-container">

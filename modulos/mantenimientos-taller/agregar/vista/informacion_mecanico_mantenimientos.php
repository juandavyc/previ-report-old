        ...
        <div class="col-12">
            <fieldset>
                ...
                <div class="row gtr-25 gtr-uniform ">
                    ...
                    <div class="col-3 col-12-small">
                        <label class="label-datos "> Periodo </label>
                    </div>
                    <div class="col-3 col-12-small">
                        <div class="input-container">
                            <i class="fas fa-heartbeat icon-input"></i>
                    ...
                    <div class="col-3 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_1_fecha_mantenimiento" id="form_1_fecha_mantenimiento" class="input_date_listener" autocomplete="off" value="01/01/2021" required="" />
                        </div>
                    </div>
                    ...
                    <div class="col-3 col-12-small">
                        <div class="input-container">
                            ...
                            <input class="text-uppercase" type="text" placeholder="Direccion del mantenimiento" name="form_1_direccion_mantenimiento" id="form_1_direccion_mantenimiento" autocomplete="off" required="">
                        </div>
                    </div>
                    ...
                    <div class="col-3 col-12-small">
                        <div class="input-container">
                            ...
                            <input class="text-uppercase" type="text" placeholder="precio de la mano de obra (total)" name="form_1_precio_mano_obra_mantenimiento" id="form_1_precio_mano_obra_mantenimiento" autocomplete="off" required="">
                        </div>
                    </div>
                    ...
                    <div class="col-3 col-12-small">
                        <div class="input-container">
                            ...
                            <input class="text-uppercase" type="text" placeholder="precio de los repuestos (total)" name="form_1_precio_repuestos_obra_mantenimiento" id="form_1_precio_repuestos_obra_mantenimiento" autocomplete="off" required="">
                        </div>
                    </div>
                    ...
                    <div class="col-3 col-12-small">
                        <div class="input-container">
                            ...
                            <input class="text-uppercase" type="text" placeholder="catidad de repuestos (total)" name="form_1_cantidad_repuestos_obra_mantenimiento" id="form_1_cantidad_repuestos_obra_mantenimiento" autocomplete="off" required="">
                        </div>
                    </div>
                    ...
                    <div class="col-9 col-12-small">
                        <label class="label-resultados" id="form_0_empresa_div">EMRPESA SAS DDD 77 7222</label>
                    </div>
                </div>
            </fieldset>
        </div>

                ...
                <div class="row gtr-25 gtr-uniform">
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <select id="form_7_tipo_comparendo_multa_sancion_conductor"
                                name="form_7_tipo_comparendo_multa_sancion_conductor" required="">
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_7_fecha_comparendo_multa_sancion_conductor"
                                id="cform_7_fecha_comparendo_multa_sancion_conductor" class="input_date_listener"
                    ...
                    <div class="col-10 col-12-small">
                        <div class="input-container">
                            <textarea id="form_7_motivo_comparendo_multa_sancion_conductor"
                                name="form_7_motivo_comparendo_multa_sancion_conductor" rows="2" required=""
                                placeholder="MOTIVO DEL COMPARENDO, MULTA O SANCION"></textarea>
                        </div>
                    </div>
                    <div class="col-12 col-12-small">
                        <div class="photo-control">
                            <div class="photo-info">
                                ...
                                <input type="text" id="form_7_foto_comparendo_multa_sancion"
                                    name="form_7_foto_comparendo_multa_sancion" value="/images/sin_imagen.png" readonly
                                    required />
                            </div>
                            <div class="photo-buttons">
                                <button class="button primary small btn-file-open"
                                    id="btn-form_7_foto_comparendo_multa_sancion" data-folder="comparendo_multa_sancion"
                                    input-id="form_7_foto_comparendo_multa_sancion"></button>
                                <button class="button primary small btn-camera-open"
                                    id="btn-form_7_foto_comparendo_multa_sancion" data-folder="comparendo_multa_sancion"
                                    input-id="form_7_foto_comparendo_multa_sancion"></button>
                                <button class="button primary small btn-camera-show"
                                    data-id="form_7_foto_comparendo_multa_sancion"></button>
                            </div>
                        </div>
                    </div>
                </div>

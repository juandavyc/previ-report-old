...
<form id="form_12_vehiculo_conductor" name="form_12_vehiculo_conductor">
    <div class="row gtr-50 gtr-uniform ">
        <div class="col-12">
            <fieldset>
                <legend>
                    <i class="far fa-folder-open"></i> Agregar vehiculos a conductor
                </legend>
                <div class="row gtr-25 gtr-uniform ">
                    ...
                    <div class="col-5 col-12-small ">
                        <div class="input-container">
                            ...
                            <input type="text" id="form_12_placa_vehiculo_conductor_input" class="text-uppercase"
                                required="" placeholder="PLACA">
                            <input type="hidden" name="form_12_placa_vehiculo_conductor"
                                id="form_12_placa_vehiculo_conductor_select" value="1" required="">
                        </div>
                    </div>
                    <div class="col-5 col-12-small">
                    ...
                    <div class="col-5 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_12_fecha_asignacion_vehiculo_conductor"
                                id="form_12_fecha_asignacion_vehiculo_conductor" class="input_date_listener"
        ...
        <div class="col-6 col-12-small">
            <button type="reset" id="form_12_limpiar_formulario"

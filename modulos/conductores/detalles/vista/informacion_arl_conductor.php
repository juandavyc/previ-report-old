...
<form id="form_4_arl_conductor" name="form_4_arl_conductor">
    <div class="row gtr-50 gtr-uniform ">
        <div class="col-12">
            <fieldset>
                <legend>
                    <i class="far fa-folder-open"></i> Agregar ARL del conductor
                </legend>
                <div class="row gtr-25 gtr-uniform">
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_4_arl_fecha_afiliacion_conductor" id="form_4_arl_fecha_afiliacion_conductor" class="input_date_listener" autocomplete="off" required="">
                        </div>
                    </div>
                    <div class="col-2 col-12-small">
                    ...
                    <div class="col-12">
                        <div class="photo-control">
                            ...
                            <div class="photo-buttons">
                                <button class="button primary small btn-file-open" id="btn-form_4_foto_arl" data-folder="arl" input-id="form_4_foto_arl"></button>

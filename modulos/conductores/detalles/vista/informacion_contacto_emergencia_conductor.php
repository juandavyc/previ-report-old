...
<form id="form_2_informacion_emergencia_conductor" name="form_2_informacion_emergencia_conductor">
    <div class="row gtr-25 gtr-uniform ">
        <div class="col-12">
            <fieldset>
                <legend>
                    <i class="fas fa-info-circle"></i> Informacion contacto de emergencia
                </legend>
                <div class="row gtr-25 gtr-uniform">
                    ...
                    <div class="col-8 col-12-small">
                        <div class="input-container">
                            ...
                            <input type="text" name="form_1_telefono_contacto_de_emergencia_conductor" id="form_1_telefono_contacto_de_emergencia_conductor" autocomplete="off" required="" class="text-uppercase" placeholder="000 000 0000">
                        </div>
                    </div>
                    <div class="col-4 col-12-small">

  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/modulos/conductores/detalles/modelo/contacto_emergencia/guardar_datos_emergencia_conductor.php',
        type: 'POST',
        data: formdata,
        contentType: false,
        cache: false,
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/modulos/conductores/detalles/modelo/contacto_emergencia/buscar_informacion_contacto_emergencia.php',
        type: 'POST',
        data: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/modulos/conductores/detalles/modelo/contacto_emergencia/eliminar_contacto_emergencia_conductor.php',
        type: 'POST',
        data: {
          id_contacto_emergencia_conductor: _id_contacto_emergencia_conductor,
        },

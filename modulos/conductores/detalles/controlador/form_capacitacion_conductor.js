...
function radio_refuerzo_input(_value) {
  ...
  if (_value == '1') {
    ...
    $('#form_10_fecha_refuerzo_capacitacion').val('');
  } else {
    $('#div_datos_refuerzo').hide(100);
    $('#form_10_fecha_refuerzo_capacitacion').val('03/06/2023');
  }
}
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/modulos/conductores/detalles/modelo/capacitacion/guardar.php',
        type: 'POST',
        data: formdata,
        contentType: false,
        cache: false,
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/modulos/conductores/detalles/modelo/capacitacion/buscar.php',
        type: 'POST',
        data: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/modulos/conductores/detalles/modelo/capacitacion/eliminar.php',
        type: 'POST',
        data: {
          id_capacitacion_conductor: _id_capacitacion_conductor,
        },

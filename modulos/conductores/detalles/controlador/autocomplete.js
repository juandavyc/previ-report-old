...
const json_autocomplete_eps = {
  ...
  url_select_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/eps_conductor/buscar_eps.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/eps_conductor/crear_eps.php',
...
const json_autocomplete_fdp = {
  ...
  url_select_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/fdp_conductor/buscar_fdp.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/fdp_conductor/crear_fdp.php',
...
const json_autocomplete_arl = {
  ...
  url_select_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/arl_conductor/buscar_arl.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/arl_conductor/crear_arl.php',
...
const json_autocomplete_entidad_examen = {
  ...
  url_select_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/entidad_examen/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/entidad_examen/crear.php',
...
const json_autocomplete_entidad_curso = {
  ...
  url_select_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/entidad_curso/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/entidad_curso/crear.php',
  input_value_default: 'SIN_ENTIDAD',
  input_select_default: '1',
  input_childs: [],
};
...
const json_autocomplete_tipo_curso = {
  ...
  url_select_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/tipo_curso/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/tipo_curso/crear.php',
...
const json_autocomplete_entidad_capacitacion = {
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/entidad_capacitacion/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/entidad_capacitacion/crear.php',
  input_value_default: 'SIN_ENTIDAD',
  input_select_default: '1',
  input_childs: [],
};
...
const json_autocomplete_tipo_capacitacion = {
  ...
  url_select_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/tipo_capacitacion/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/tipo_capacitacion/crear.php',
...
const json_autocomplete_vehiculo_conductor = {
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/vehiculo_conductor/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/modulos/assets/autocomplete/vehiculo_conductor/crear.php',

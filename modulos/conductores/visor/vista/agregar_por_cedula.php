    ...
    <div class="row gtr-50 gtr-uniform">
        ...
        <div class="col-5 col-12-small">
            <aside class="note-wrap note-yellow ">
                ...
                se puede editar los datos. <br><b> P.D. </b>Solo soporte técnico puede <b>ELIMINAR CONDUCTORES</b>
            </aside>
        </div>
        <div class="col-12">
            <fieldset>
                <legend>
                    <i class="fas fa-search"></i> Verificar Cedula
                </legend>
                <div class="row gtr-25 gtr-uniform">
                    <div class="col-3 col-12-small">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" id="form_1_cedula" placeholder="" name="form_1_cedula" class="text-uppercase" value="" maxlength="20" required="" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-5 col-12-small">

        ...
        if (
            ...
            if (strcmp($database->status(), "bien") == 0) {
                ...
                $php_array_filtro = array(
                    '0' => "rev.id_previautos_pdf",
                    '1' => "rev.id_previautos_pdf",
                    '2' => "veh.placa_previautos_vehiculo",
                    '3' => "veh.documento_previautos_vehiculo",
                );
                $php_array_order = array(
                    'nro' => "rev.id_previautos_pdf",
                    'placa' => "veh.placa_previautos_vehiculo",
                    'documento' => "veh.documento_previautos_vehiculo",
                    'tipo' => "tip.nombre_reviautos_tipo_pdf",
                    'bimensual' => "rev.bimensual_previautos_pdf",
                    'expedicion' => "rev.fecha_expedicion_previautos_pdf",
                    'vencimiento' => "rev.fecha_vencimiento_previautos_pdf",
                    'responsable' => "usu.id_usuario",
                    #'direccion' => "empr.direccion",
                    'opciones' => "rev.id_previautos_pdf",
                );
                $php_array_by = array(
                    'asc' => "ASC",
                    'desc' => "DESC",
                ...
                $form_tipo = htmlspecialchars($_POST["form_0_tipo"]);
                ...
                $arrayResponse = $revision->getRevisionBuscador(
                    array(

...
autocomplete_with_insert_child({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/vehiculo_conductor/buscar_empresa.php',
  url_insert_ajax:
    PROTOCOL_HOST + '/modulos/siniestros/visor/modelo/crear_vehiculo.php',
  input_value_default: '',
  input_select_default: '0',
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url:
            PROTOCOL_HOST +
            '/modulos/mantenimientos-super/visor/modelo/crear_mantenimiento.php',
          type: 'POST',
          data: form_data,
          headers: {
          ...
          .done(function (response) {
            ...
            if (response.status === 'bien') {
              ...
              window.location.replace(
                PROTOCOL_HOST +
                  '/modulos/mantenimientos-taller/agregar/index.php?id=' +
                  response.message
              );
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/modulos/mantenimientos-super/visor/modelo/informacion_vehiculo.php',
        type: 'POST',
        data: {

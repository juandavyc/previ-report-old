  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/modulos/vehiculos/detalles/modelo/tarjeta_de_operacion/form.php',
        type: 'POST',
        data: formdata,
        contentType: false,
        cache: false,
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/modulos/vehiculos/detalles/modelo/tarjeta_de_operacion/informacion.php',
        type: 'POST',
        data: {
  ...
  let self = $.confirm({
    ...
    content: function () {
      return $.ajax({
        url:
          PROTOCOL_HOST +
          '/modulos/vehiculos/detalles/modelo/tarjeta_de_operacion/eliminar.php',
        type: 'POST',
        data: {
          id_elemento: _id_elemento,

...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/autoridad_transito/buscar_autoridad_transito.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/autoridad_transito/crear_autoridad_transito.php',
...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/preventiva_vehiculo/buscar_preventiva.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/preventiva_vehiculo/crear_preventiva.php',
...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/modalidad_transporte_general/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/modalidad_transporte_general/crear.php',
...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/rango_de_accion_general/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/rango_de_accion_general/crear.php',
...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/modalidad_servicio_general/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/modalidad_servicio_general/crear.php',
...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/aseguradora_poliza_general/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/aseguradora_poliza_general/crear.php',
...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/tipo_poliza_general/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/tipo_poliza_general/crear.php',
...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/entidad_transito_general/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/entidad_transito_general/crear.php',
...
autocomplete_with_insert_father({
  ...
  url_select_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/tipo_solicitud_general/buscar.php',
  url_insert_ajax:
    PROTOCOL_HOST +
    '/modulos/assets/autocomplete/tipo_solicitud_general/crear.php',
  input_value_default: 'SIN ENTIDAD TRANSITO',
  input_select_default: '1',
  input_childs: [],
});

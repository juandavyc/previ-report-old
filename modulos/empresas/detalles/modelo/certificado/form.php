...
require DOCUMENT_ROOT . '/modulos/assets/clases/certificado_empresa/create.php';
...
if (
    ...
    isset($_POST["form_1_nombre_certificado"]) &&
        ...
        if (strcmp($database->status(), "bien") == 0) {
            ...
            $arrayResponse = $certificado->setCertificado(
                array(
                    ...
                    'NOMBRE' => htmlspecialchars($_POST['form_1_nombre_certificado']),
                    ...
                    'ID_EMPRESA' => encrypt($_POST['form_1_id_empresa'], 2),

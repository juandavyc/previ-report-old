...
<head>
    <title>Detalles Empresa - Hojas de vida</title>
    <meta charset="utf-8" />
            ...
            <section class="wrapper style4 container max">
                <div class="row gtr-50 gtr-uniform">
                    ...
                    <div class="col-12 align-center">
                        <h2 id="form_0_numero_empresa_div"></h2>
                        <h3 id="form_0_nombre_empresa_div"></h3>
                        <h4 id="form_0_nit_empresa_div"></h4>
                    </div>
                    <div class="col-12">
                        <div id="vehiculo_agregar_accordion">
                            <h3 class="accordion_consulta" data-id="0"> Información de la empresa</h3>
                            <div id="accordion_consulta_0">
                                <?php require 'vista/form_informacion_empresa.html';?>
                            </div>
                            <h3 class="accordion_consulta" data-id="1">Certificaciones </h3>
                            <div id="accordion_consulta_1">
                                <?php require 'vista/from_certificado.html';?>
                            </div>
                            <h3 class="accordion_consulta" data-id="2">Estado de la empresa ( Activo o Suspendido )
                            </h3>

...
require DOCUMENT_ROOT . '/modulos/assets/clases/empresa/create.php';
...
if (
    ...
    if (
        ...
        if (strcmp($database->status(), "bien") == 0) {
            ...
            $empresa = new CreateEmpresa($database->myconn);
            $arrayResponse = $empresa->setEmpresaNit($nit, $id_usuario);

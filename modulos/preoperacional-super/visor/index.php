...
<head>
    <title>Visor de Preoperacionales - Hojas de vida</title>
    <meta charset="utf-8" />
    ...
    <style>
        ...
        table.alt tbody tr td:nth-child(4) {
            font-weight: bold;
        }
    </style>
</head>
    ...
    <div id="page-wrapper">
        ...
        <article id="main">
            <header class="special container">
                <span class="icon solid fas fa-paste"></span>
                <h2>Visor de Preoperacionales </h2>
                <p><?= htmlspecialchars($_SESSION["session_user"][3]); ?></p>
            </header>
            <div id="tab-visor">
                <ul>
                    <li><a href="#tab-1" class="icon solid fa-search"> Buscador </a></li>
                    <li><a href="#tab-2" class="icon solid fa-plus"> Nueva Preoperacional </a></li>
                </ul>
                <div id="tab-1">

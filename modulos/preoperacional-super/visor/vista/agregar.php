<form id="form_1_nuevo_mantenimiento" name="form_1_nuevo_mantenimiento">
    <div class="row gtr-25 gtr-uniform">
        ...
        <div class="col-5 col-12-small">
            <aside class="note-wrap note-yellow">
                <ol>
                    ...
                    <li><b>Su Firma</b></li>
                    <li>
                        </b>Solo soporte técnico puede <b>ELIMINAR PREOPERACIONALES</b>
                    </li>
                </ol>
            </aside>
        </div>
                ...
                <div class="row gtr-25 gtr-uniform">
                    ...
                    <div class="col-3 col-12-small">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" id="form_1_vehiculo_input" value="" placeholder="Placa" class="text-uppercase autocomplete" required="" />
                            <input type="hidden" name="form_1_vehiculo" id="form_1_vehiculo_select" value="" data-default="1" required="" />
                            <input type="hidden" name="form_1_empresa" id="form_1_empresa" value="" data-default="0" required="" />
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="form_1_observaciones" name="form_1_observaciones" rows="2" maxlength="200"></textarea>
                    </div>
                </div>
            </fieldset>
        </div>
        ...
        <div class="col-6 col-12-small">
            <input type="submit" value="Asignar para preoperacional" id="form_1_submit" class="primary small fit" disabled>
        </div>
        <div class="col-6 col-12-small">

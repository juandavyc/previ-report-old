            ...
            <section class="wrapper style4 container medium" style="padding: 2em;">
                <div class="row gtr-50 gtr-uniform">
                    <div class="col-4 col-12-small">
                        ...
                        <ol class="ol-mapa">
                            <li> <a href="<?= ROOT ?>/modulos/">Inicio</a> </li>
                            <li> <a href="<?= ROOT ?>/modulos/documentacion/">Documentacion </a></li>
                            <li> Modulos</li>
                            <ol class="ol-mapa">
                                <li><a href="<?= ROOT ?>/modulos/vehiculos/visor/">Vehiculos</a></li>
                                <li><a href="<?= ROOT ?>/modulos/conductores/visor/">Conductores</a></li>
                                <li><a href="<?= ROOT ?>/modulos/empresas/visor/">Empresas</a></li>
                                <li><a href="<?= ROOT ?>/modulos/talleres/visor/">Talleres</a></li>
                                <li><a href="<?= ROOT ?>/modulos/usuarios/visor/">Usuarios</a></li>
                                <li><a href="<?= ROOT ?>/modulos/siniestros/visor/">Siniestros</a></li>
                                <li>
                                    <a href="<?= ROOT ?>/modulos/mantenimientos-super/visor/">mantenimientos </a>
                                </li>
                                <li><a href="<?= ROOT ?>/modulos/preoperacional-super/visor/">Preoperacional </a></li>
                                <li><a href="<?= ROOT ?>/modulos/previautos/">Previautos
                                    </a></li>
                            </ol>
                            <li> Mi cuenta</li>
                            <ol class="ol-mapa">
                                <li>
                                    <a href="<?= ROOT ?>/modulos/mi-cuenta/">Gestionar</a>
                                </li>
                                <li>
                                    <a id="cerrar_sesion_act" name="cerrar_sesion_act"
                                        href="<?= ROOT ?>/modulos/cerrar.php">Cerrar
                                        sesion</a>
                                </li>
                            </ol>
                        </ol>
                    ...
                    <div class="col-8 col-12-small">
                        ...
                        <div class="row gtr-50 gtr-uniform">
                            ...
                            <div class="col-9 col-12-small">
                                <p style="font-weight: bold; color:red;">Cualquier alteración al código fuente, base de
                                    datos realizada por desarrolladores
                                    ajenos al proyecto, nos exime de cualquier fallo en la plataforma.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        ...
                        <div class="row gtr-50 gtr-uniform">
                            <div class="col-3 col-12-small">
                                <label class="label-datos"> Ver documentación de: </label>
                            </div>
                            <div class="col-9 col-12-small">
                                <div class="input-container">
                                    ...
                                    <select id="tipo-video-select" required="">
                                        ...
                                        <optgroup label="Modulos">
                                            ...
                                            <option value="3">Conductores</option>
                                            <option value="4">Empresas</option>
                                            <option value="5">Talleres</option>
                                            <option value="6">Usuarios</option>
                                            <option value="8">Siniestros</option>
                                            <option value="7">Mantenimientos</option>
                                            <option value="9">Preoperacional</option>
                                        </optgroup>
                                        <optgroup label="Extra">
                                            <option value="10">Utilidades</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-9 col-12-small align-center">
                                ...
                                <div class="video-container">
                                    <video class="video" id="video-player" poster="sources/portada.jpg" controls>
                                        <source src="sources/video_demo.mp4" type="video/mp4">
                                    </video>
                                </div>
                            </div>
                        </div>
